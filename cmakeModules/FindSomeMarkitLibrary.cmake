...
macro(_FIND_SML_HEADER _include_dir)
...
set(package_required ${SomeMarkitLibrary_FIND_REQUIRED})
set(package_quietly ${SomeMarkitLibrary_FIND_QUIETLY})
set(SomeMarkitLibrary_FIND_REQUIRED)
set(SomeMarkitLibrary_FIND_QUIETLY 1)

FIND_PACKAGE_HANDLE_STANDARD_ARGS(SomeMarkitLibrary DEFAULT_MSG
    SomeMarkitLibrary_LIBRARY SomeMarkitLibrary_INCLUDE_DIR)
set(SomeMarkitLibrary_FIND_QUIETLY)

if(SomeMarkitLibrary_FOUND)
   _SML_APPEND_LIBRARIES(SomeMarkitLibrary_LIBRARIES SomeMarkitLibrary_LIBRARY)
else()
	set(SomeMarkitLibrary_FIND_REQUIRED ${package_required})
	set(SomeMarkitLibrary_FIND_QUIETLY ${package_quietly})
